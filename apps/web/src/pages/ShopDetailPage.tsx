...
const CATEGORY_IMAGES: Record<string, Record<string, string>> = {
  ...
  FEMALE: {
    "HAIRCUT": "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&q=75&fit=crop&auto=format",
    "HAIR_COLOR": "https://images.unsplash.com/photo-1522337660859-02fbefca4702?w=800&q=75&fit=crop&auto=format",
    "MASSAGE": "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800&q=75&fit=crop&auto=format",
    "FACIAL": "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=800&q=75&fit=crop&auto=format",
    "WAXING": "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=800&q=75&fit=crop&auto=format",
  ...
  UNISEX: {
    "HAIRCUT": "https://images.unsplash.com/photo-1633681926022-84c23e8cb2d6?w=800&q=75&fit=crop&auto=format",
    "HAIR_COLOR": "https://images.unsplash.com/photo-1522337660859-02fbefca4702?w=800&q=75&fit=crop&auto=format",
    "MASSAGE": "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800&q=75&fit=crop&auto=format",
    "FACIAL": "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=800&q=75&fit=crop&auto=format",
    "BEARD": "https://lh3.googleusercontent.com/aida-public/AB6AXuBMA6P4b5OkcBylTvcyVk2gDYh17iDrBU2b4DYA4QE0A8kz8Clj1ANmSlAtBMQVOlCgn1ZUEg5i57ta4y2nbQBwN07Oh9jgItdhJINcIv-mX3X3kVEcE3SSe_6UtvM3RU_BOV0pF9Ae2LSN9YUVH6aG717FsoClRoJHSHDa2Zi-_RRH6Q31QNWRwQdtgYaM1b3-_HiRO6dh7tIeDlh9C3djV8sDeSUsVzlPOp9H4KbjWdAxAjWK5vBad1pGBgzlG-pmnW3wXsgznhGo",
    ...
    "OTHER": "https://lh3.googleusercontent.com/aida-public/AB6AXuCgFHRy78LcO4So8cu4g0Gfcvk-Vk9vRBtwKCo_iRKIlzKqrdhnRWyF2aI1du-I2OWPvRl9BPjcYOBefYbBceBH9DYHU-oYz58A8FAvFW1gLFYzYJsDaOPJomH9P1ACxzyzPjaimnax2ZEOkx869HyF8qOAr8pNskCDI16XF86Sc8dlMM-N-zd2D5LD-sgM-AmPn5cy90Ng0-xooC6x3WQClYPiVvCa6njnQLNKXJgdtHQ0KicwirXyMnU4w9D37Ts54_PxQMjgvoBI",
    "DEFAULT": "https://lh3.googleusercontent.com/aida-public/AB6AXuCgFHRy78LcO4So8cu4g0Gfcvk-Vk9vRBtwKCo_iRKIlzKqrdhnRWyF2aI1du-I2OWPvRl9BPjcYOBefYbBceBH9DYHU-oYz58A8FAvFW1gLFYzYJsDaOPJomH9P1ACxzyzPjaimnax2ZEOkx869HyF8qOAr8pNskCDI16XF86Sc8dlMM-N-zd2D5LD-sgM-AmPn5cy90Ng0-xooC6x3WQClYPiVvCa6njnQLNKXJgdtHQ0KicwirXyMnU4w9D37Ts54_PxQMjgvoBI"
  }
};
                    ...
                    <div key={svc.id} className="py-6 border-b border-border-light flex gap-4 first:pt-4 last:border-b-0">
                      ...
                      <div className="relative w-28 md:w-32 aspect-[16/9] flex-shrink-0">
                        <img
                          ...
                          src={
                            svc.imageUrl || 
                            (CATEGORY_IMAGES[shop.category]?.[svc.category]) || 
                            (CATEGORY_IMAGES[shop.category]?.DEFAULT) || 
                            (CATEGORY_IMAGES.UNISEX.DEFAULT)
                          }
                        />
                        <button
